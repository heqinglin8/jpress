 ...
 *
 */
public class SubmitFormAddon implements Addon {
    ...
    public void onInstall(AddonInfo addonInfo) {
         ...
         */
        System.out.println("SubmitFormAddon onInstall");
    ...
    public void onUninstall(AddonInfo addonInfo) {
        ...
        System.out.println("SubmitFormAddon onUninstall");
    }
    ...
    public void onStart(AddonInfo addonInfo) {
        ...
        System.out.println("SubmitFormAddon onStart");
    }
    ...
    public void onStop(AddonInfo addonInfo) {
        ...
        System.out.println("SubmitFormAddon onStop");
