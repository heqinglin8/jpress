...
import io.jpress.web.interceptor.ApiEnableInterceptor;
 ...
 */
@Before({ApiEnableInterceptor.class, UserInterceptor.class})
public abstract class SFApiControllerBase extends ControllerBase {
