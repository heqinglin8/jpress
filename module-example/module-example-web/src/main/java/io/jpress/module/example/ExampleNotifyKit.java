...
public class ExampleNotifyKit {

    private static ExecutorService fixedThreadPool = NamedThreadPools.newFixedThreadPool(3,"product-notify");

    public static void doNotifyAdministrator(Example product, ExampleComment comment, User user) {
    ...
    public static void doNotifyAdministratorBySms(Example product, ExampleComment comment) {
        boolean enable = JPressOptions.getAsBool("example_comment_sms_notify_enable");
        if (enable) {
    ...
    private static void doSendSms() {
        ...
        String template = JPressOptions.get("example_comment_sms_notify_template");
        String sign = JPressOptions.get("example_comment_sms_notify_sign");
    ...
    public static void doNotifyAdministratorByEmail(Example product, ExampleComment comment, User user) {
    ...
    private static void doSendEmail(Example product, ExampleComment comment, User user) {
