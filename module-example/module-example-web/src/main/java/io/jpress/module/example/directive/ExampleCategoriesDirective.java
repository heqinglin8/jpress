 ...
 * @Title: 产品分类：分类、标签等
 */
@JFinalDirective("exampleCategories")
public class ExampleCategoriesDirective extends JbootDirectiveBase {
    ...
    public void onRender(Env env, Scope scope, Writer writer) {
        ...
        List<ExampleCategory> categories = categoryService.findListByProductId(id, type);
