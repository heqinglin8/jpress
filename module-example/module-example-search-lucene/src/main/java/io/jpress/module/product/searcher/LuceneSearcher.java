...
public class LuceneSearcher implements ExampleSearcher {
    ...
    public void addExample(Example example) {
        ...
        try {
            ...
            Document doc = createDocument(example);
    ...
    public Page<Example> search(String keyword, int pageNum, int pageSize) {
        ...
        try {
            ...
            List<Example> products = toProductList(indexSearcher, topDocs, highlighter, keyword);
    ...
    private static Page<Example> newPage(int pageNum, int pageSize, int totalRow, List<Example> products) {
        int totalPages;
    ...
    private static Document createDocument(Example product) {
    ...
    private List<Example> toProductList(IndexSearcher searcher, TopDocs topDocs, Highlighter highlighter, String keyword) throws Exception {
        List<Example> products = new ArrayList<>();
        Analyzer analyzer = createAnalyzer();
