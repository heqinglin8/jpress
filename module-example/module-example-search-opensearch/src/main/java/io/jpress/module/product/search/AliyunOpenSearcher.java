 ...
 */
public class AliyunOpenSearcher implements ExampleSearcher {
    ...
    @Override
    public void addExample(Example product) {
        if (autoSync) {
            return;
        }
        try {
    ...
    @Override
    public void updateExample(Example product) {
        if (autoSync) {
            return;
        }
        deleteExample(product.getId());
        addExample(product);
    }
