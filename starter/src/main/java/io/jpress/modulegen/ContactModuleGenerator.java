 ...
 */
public class ContactModuleGenerator {
    ...
    private static String moduleName = "contact";
    private static String dbTables = "contact";
    private static String modelPackage = "io.jpress.module.contact.model";
    private static String servicePackage = "io.jpress.module.contact.service";
